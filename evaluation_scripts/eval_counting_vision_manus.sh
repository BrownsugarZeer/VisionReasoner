...
REASONING_MODEL_PATH="/gpfs/yuqiliu/vision_zero_workdir/19_run_qwen2_5_7b_multiobject_rewardv4_refcoco_lvis_lisaplus_grefcoco_n8_nonrepeat_rollout32/global_step_200/actor/huggingface"
...
for idx in {0..7}; do
    ...
    python evaluation_scripts/evaluation_vision_manus_count.py \
...
python evaluation_scripts/calculate_counting.py --output_dir $OUTPUT_PATH